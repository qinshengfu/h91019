	...
	<body>
		<div class="mui-content pbom50">
			...
			<div class="silderbox">
				<ul class="hiSlider hiSlider3">
					<c:forEach items="${cfCarousel}" var="var">
						<li class="hiSlider-item">
							<a href="front/index"><img src="${var.IMGPATH}"></a>
						</li>
					</c:forEach>
				</ul>
			</div>
			...
			<div class="menunav mui-text-center">
				<ul class="mui-table-view">
					<li class="mui-table-view-cell auto flexaroundplay linehide">
						<a href="front/clothes"><img src="static/front/images/indexicon7.png" class="indexicon"/><p style="width: 50px;">生鲜</p></a>
						<a href="front/luxury"><img src="static/front/images/indexicon8.png" class="indexicon"/><p style="width: 50px;">美食</p></a>
						<a href="front/car"><img src="static/front/images/indexicon1.png" class="indexicon"/><p style="width: 50px;">美妆日化</p></a>
					</li>
					<li class="mui-table-view-cell auto flexaroundplay">
						<a href="front/bedclothes"><img src="static/front/images/indexicon5.png" class="indexicon"/><p style="width: 50px;">数码家电</p></a>
						<a href="front/phone"><img src="static/front/images/indexicon4.png" class="indexicon"/><p style="width: 50px;">日用百货</p></a>
			...
			<ul class="mui-table-view">
				<li class="mui-table-view-cell">
					<a href="front/index" class="mui-navigate-right">
						热卖商品
					</a>
				</li>
			</ul>
			<div class="equallylist mtop0" style="margin-bottom: 10px;">
				...
				<div>
					<ul class="shoplist">
						<c:forEach items="${cfProduct}" var="var">
							<li class="shoplistli">
		...
		<footer class="footer">
			<div class="flexaroundplay footnav">
				<a href="front/index" class="active"><i class="iconfont icon-shouye6"></i>财富商城</a>
