	...
	<body>
		...
		<div class="mui-content">
			...
			<div class="order_list">
				...
				<div class="order_txt order_txt1">
					<div class="order_txt_1">
						<div class="order_txt_pic">
							<img src="${jfProduct.IMGPATH1}" />
							<div class="width_pic">
								<div class="mui-ellipsis">
									${jfProduct.NAME}
								</div>
								<!-- <p>发荻港的烦恼</p> -->
								<div>￥${jfProduct.PRICE}</div>
							</div>
						</div>
					</div>
				...
				<div class="order_txt_3">
					...
					<div>支付积分：<span>${pd.TOTAL}</span></div>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			function order_do(){
				...
				var JFPRODUCT_ID = '${jfProduct.JFPRODUCT_ID}';
				var MEMBER = '${member.MEMBER}';
				if(ADDRESS_ID != ''){
					$.ajax({
						type:'post',
						url :'front/order_do',
						data:{JFPRODUCT_ID:JFPRODUCT_ID,ADDRESS_ID:ADDRESS_ID,QUANTITY:QUANTITY,TOTAL:TOTAL,MEMBER:MEMBER},
