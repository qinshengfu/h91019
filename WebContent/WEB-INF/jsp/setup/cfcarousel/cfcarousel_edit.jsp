		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="cfcarousel/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="CFCAROUSEL_ID" id="CFCAROUSEL_ID" value="${pd.CFCAROUSEL_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;line-height: 150px;">
									图片:
									<input type="hidden" name="IMGPATH" id="IMGPATH" value="${pd.IMGPATH}" maxlength="255" placeholder="这里输入图片路径" title="图片路径" style="width:98%;"/>
								</td>
								<td>
									<%-- <c:if test="${!(not empty pd.IMGPATH)}"> --%>
										<img alt="" onclick="file1();" id="headimg" src="static/images/upload.png" width="150" height="150">
									<%-- </c:if>
									<c:if test="${not empty pd.IMGPATH}">
										<img alt="" onclick="file1();" id="headimg" src="${pd.IMGPATH}" width="150" height="150">
									</c:if> --%>
