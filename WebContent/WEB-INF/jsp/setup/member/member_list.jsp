								...
								<td>
									<div class="nav-search">
										<span class="input-icon">
											<input type="text" placeholder="这里输入账号" class="nav-search-input" id="nav-search-input" autocomplete="off" name="keywords" value="${pd.keywords}" placeholder="这里输入账号"/>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">推荐码</th>
									<!-- <th class="center">代路径</th>
									<th class="center">代数</th> -->
									<!-- <th class="center">头像</th> -->
									<th class="center">等级</th>
									<!-- <th class="center">等级数</th> -->
									<th class="center">佣金</th>
									<th class="center">积分</th>
									<th class="center">财富</th>
									<th class="center">直推人数</th>
									<!-- <th class="center">消费总额</th>
									<th class="center">升级余数</th> -->
									<!-- <th class="center">是否出局</th>
									<th class="center">接点人</th>
									<th class="center">层路径</th>
									<th class="center">层数</th>
									<th class="center">所处位置</th>
									<th class="center">左区</th>
									<th class="center">右区</th>
									<th class="center">是否一次性消费</th> -->
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<%-- <td class='center'>${var.PWD}</td> --%>
											<td class='center'>${var.REFERRER}</td>
											<%-- <td class='center'>${var.R_PATH}</td>
											<td class='center'>${var.R_LEVEL}</td> --%>
											<%-- <td class='center'>${var.AVATAR}</td> --%>
											<td class='center'>${var.MEM_LEVEL}</td>
											<%-- <td class='center'>${var.LEVEL_NUM}</td> --%>
											<td class='center'>${var.COMMISSION}</td>
											<td class='center'>${var.INTEGRAL}</td>
											<td class='center'>${var.WEALTH}</td>
											<td class='center'>${var.DIRECTPUSH}</td>
											<%-- <td class='center'>${var.CONSUMPTION}</td>
											<td class='center'>${var.UPGRADE}</td>
											<td class='center'>${var.OUTMONEY}</td>
											<td class='center'>${var.CONTACT}</td>
											<td class='center'>${var.C_PATH}</td>
											<td class='center'>${var.C_LEVEL}</td>
											<td class='center'>${var.PLACE}</td>
											<td class='center'>${var.LEFT}</td>
											<td class='center'>${var.RIGHT}</td>
											<td class='center'>${var.ONETIME}</td> --%>
