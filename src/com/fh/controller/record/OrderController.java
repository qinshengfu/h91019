...
import com.fh.service.record.OrderManager;
...
public class OrderController extends BaseController {
	...
	public String ship() throws Exception{
		...
		order.put("STATE", "待收货");
		order.put("DELIVERYTIME", Tools.date2Str(new Date()));
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("record/order/order_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("record/order/order_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var4", varOList.get(i).getString("IMGPATH"));	    //4
			vpd.put("var5", varOList.get(i).get("QUANTITY").toString());	//5
			vpd.put("var6", varOList.get(i).get("TOTAL").toString());	//6
			...
			vpd.put("var10", varOList.get(i).getString("DETAILEDADD"));	    //10
			vpd.put("var11", varOList.get(i).getString("STATE"));	    //11
			vpd.put("var12", varOList.get(i).getString("ORDERTIME"));	    //12
			vpd.put("var13", varOList.get(i).getString("PAYMENTTIME"));	    //13
			vpd.put("var14", varOList.get(i).getString("DELIVERYTIME"));	    //14
			vpd.put("var15", varOList.get(i).getString("RECEIPTTIME"));	    //15
			varList.add(vpd);
		}
