...
public class Const {
	...
	public static final String SESSION_MEMUSER = "sessionmemuser";         //session 用的会员用户
	public static final String ACCOUNT = "account";							//session 用的 会员资产表
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login_toLogin)|(login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)|(uploadImgs)|(static/front)|(adminImg)|(uploadFiles)|(#bottom)).*";	//不对匹配该值的访问路径拦截（正则）
	public static final String NO_DEFAULTERINTERCEPTOR_PATH = ".*/((release)|(#bottom)).*";//默认开放/不拦截  
